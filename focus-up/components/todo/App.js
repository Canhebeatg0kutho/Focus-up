...
const configuration = {
  method: "get",
  url:"http://54.83.151.50:3000/todo"
}
axios(configuration)
...
console.log([toDoList])
  ...
  const handleToggle = (id) => {
    ...
    axios.patch(`http://54.83.151.50:3000/todo/update/${id}`)
  ...
  const handleFilter = () => {
    fetch('http://54.83.151.50:3000/todo/delete', {
      method: 'DELETE',
    })
    try{
  ...
  const addTask = async() => {
    const updated = await axios.get("http://54.83.151.50:3000/todo")
